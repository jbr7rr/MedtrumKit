        ...
        VStack {
            List {
                Section {
                    ...
                    Text(LocalizedString("You will start by setting up your insulin type & basic patch settings before activating your patch.", comment: "Welcome text for MedtrumKit"))
                }
            }
            Spacer()
